<?php /**
 * Empty Posts Result For post search.
 * @package Silohon */ ?>

<div class="pages_404">
    <div class="header_404">
        <h2 class="title_404">Not Found</h2>
        <p class="p_404">Sorry, You search for <span style="color:#000;">"<?php the_search_query(); ?>"</span> is not found.</p>
    </div>
</div>
