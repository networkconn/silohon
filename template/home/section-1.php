...
<section class="silohon_sec">
    <div class="silohon_sec_title">
        <span class="sec_title"><?php echo get_option('option_section_1'); ?></span>
    </div>
    <div class="grid2">
        <?php $option_section_1 = new Wp_query( array(
            'posts_per_page' => 2,
            'category_name' => get_option('option_section_1'),
        )); while($option_section_1->have_posts()) : $option_section_1->the_post(); ?>
    ...
    <div class="grid4">
        ...
        <?php while($option_section_1->have_posts()) : $option_section_1->the_post(); $count++; ?>
